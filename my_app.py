...
number = st.number_input('Минимальное количество ночей', min_value = 1, max_value = 10)
res.append(number)

london = st.number_input('Удаленность от центра Лондона, км', min_value = 0, max_value = 20)
res.append(london)
