...
st.sidebar.write('Модель построена с использованием данных c Airbnb, 40к данных - стоимость аренды в Лондоне.')
st.sidebar.write('В демонстационной версии использованы не все доступные признаки. Регрессор, выбранный для обучения - Сatboost')
