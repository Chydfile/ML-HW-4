...
deposit = st.slider('Депозит, фунты', 0, 1000, 0, int(100))
res.append(deposit)

cleaning = st.slider('Стоимость финальной уборки, фунты', 0, 500, 0, int(50))
res.append(cleaning)
...
st.write('**Примерная стоимость аренды за ночь, фунты:**', int(y))
